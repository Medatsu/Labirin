...
public class CameraController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        var frustumScale = 2 * camDistance * Mathf.Tan(cam.fieldOfView * 0.5f * Mathf.Deg2Rad);
    ...
    private void Drag(Touch[] touches)
    {
        ...
        transform.position -= new Vector3(touch.deltaPosition.x, 0,touch.deltaPosition.y) * 0.001f;
    }
    ...
    private void Zoom(Touch[] touches)
    {
        ...
        else
        {
            ...
            var y = Mathf.Clamp(cam.transform.position.y,-10,-1);
